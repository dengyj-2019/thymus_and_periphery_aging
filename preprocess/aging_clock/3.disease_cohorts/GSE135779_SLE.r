...
ind_plot_df$group <- TN$Groups[match(ind_plot_df$batch, TN$batch)]
ind_plot_df <- ind_plot_df[grepl('SLE', ind_plot_df$group),]
...
saveRDS(ind_plot_df, file = 'SLE_ind_plot_df.rds')
