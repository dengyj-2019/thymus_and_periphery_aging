...
ind_plot_df$group <- TN$group[match(ind_plot_df$batch, TN$batch)]

ind_plot_df <- ind_plot_df[!ind_plot_df$group %in% 'HC',]
...
saveRDS(ind_plot_df, file = 'MG_ind_plot_df.rds')
